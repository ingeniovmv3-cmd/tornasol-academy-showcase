        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="animate-fade-in">
              <Badge className="bg-accent/10 text-accent hover:bg-accent/20 border-accent/20 px-4 py-2">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-up">
              ...
              <span className="gradient-text">certificaciones tech</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up animate-delay-200">
              <Button
                ...
                className="bg-primary text-primary-foreground hover:shadow-glow transition-all text-lg px-8 py-6"
              >
                Inscríbete Ahora
          ...
          <div className="relative animate-fade-in animate-delay-400">
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 w-24 h-24 rounded-full animated-gradient opacity-60 blur-2xl"></div>
            <div className="absolute -bottom-4 -left-4 w-32 h-32 rounded-full bg-accent/30 opacity-60 blur-2xl"></div>
          </div>
        </div>

        {/* Trust Indicators */}
        <div className="mt-20 pt-20 border-t border-border animate-fade-up animate-delay-500">

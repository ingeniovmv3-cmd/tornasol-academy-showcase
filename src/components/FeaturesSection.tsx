  ...
  return (
    <section id="overview" className="relative py-20 ">
      ...
      <div className="absolute lg:inset-0 z-0">
        <div className="absolute top-0 -left-32 w-14 lg:w-96 h-14 lg:h-96 bg-primary/10 rounded-full filter blur-3xl opacity-70 animate-pulse-light"></div>
        <div className="absolute top-1/2 -right-32 w-14 lg:w-96 h-14 lg:h-96 bg-accent/10 rounded-full filter blur-3xl opacity-70 animate-pulse-light animate-delay-200"></div>
        <div className="absolute bottom-0 -left-12 w-14 lg:w-96 h-14 lg:h-96 bg-secondary/10 rounded-full filter blur-3xl opacity-70 animate-pulse-light animate-delay-100"></div>
      </div>
